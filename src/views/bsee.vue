<template>
  <div class="bseeTitle">Bachelor of Science in Electrical Engineering</div>
  <div class="bseeLeft">
    <div class="bseeCol bseeCol1">
      <div class="bseeColTitle"></div>
    </div>
...
export default {
  name: "app",
  created() {
    document.title = "Electrical Engineer";
  },
};
</script>
